...
export function EditCaseStudyForm({ caseStudy }: { caseStudy: CaseStudy }) {
  ...
  const [techStack, setTechStack] = useState(caseStudy.techStack.join(", "));
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-text-primary mb-6">Edit Case Study</h1>

      <form action={updateCaseStudy} className="max-w-2xl space-y-5">
